...
export function middleware(request: NextRequest) {
  ...
  const publicRoutes = ["/login", "/register", "/verify-otp", "/forgot-password", "/book", "/contact", "/form", "/search", "/api/public", "/api/booking", "/api/auth/login", "/api/auth/register", "/api/auth/verify-otp", "/api/auth/resend-otp", "/api/auth/send-sms-otp", "/api/auth/send-whatsapp-otp", "/api/auth/forgot-password", "/api/auth/google", "/api/test/seed", "/api/ai/voice", "/api/ai/chat", "/api/health"];
