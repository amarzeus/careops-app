    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Make an AI-powered voice call to {contact.name}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          <div className="rounded-lg bg-muted p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">{contact.phone || "No phone number"}</p>
              </div>
              {contact.phone && (
          ...
          {callResult && (
            <div
              className={`rounded-lg border p-4 ${callResult.success
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <p
                    className={`font-medium ${callResult.success
                  ...
                  <p
                    className={`text-sm ${callResult.success
