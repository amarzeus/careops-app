...
const NUMBER_COSTS: Record<string, Record<string, number>> = {
  ...
  DE: { local: 1.5, tollfree: 4.0, mobile: 3.0 },
  FR: { local: 1.5, tollfree: 4.0, mobile: 3.0 },
  JP: { local: 3.0, tollfree: 5.0, mobile: 4.0 },
};
...
const REGULATORY_REQUIREMENTS: Record<string, Record<string, RegulatoryRequirement>> = {
  ...
  IN: {
    ...
    mobile: {
      required: true,
      documents: ["identity_proof", "address_proof"],
      addressRequired: true,
      addressType: "local",
    },
  },
...
function getMonthlyCost(country: string, type: string): number {
  return NUMBER_COSTS[country]?.[type] || 3.0;
}
...
function getMockNumbers(countryCode: string): AvailableNumber[] {
  const mockData: Record<string, AvailableNumber[]> = {
    US: [
      ...
      {
        phoneNumber: "+1 (650) 555-0103",
        friendlyName: "+1 (650) 555-0103",
        locality: "Palo Alto",
        region: "CA",
        isoCountry: "US",
        capabilities: { voice: true, sms: true, mms: true },
    ...
    IN: [
      {
        phoneNumber: "+91 22 5555 0101",
        friendlyName: "+91 22 5555 0101",
        locality: "Mumbai",
        region: "MH",
        isoCountry: "IN",
      ...
      {
        phoneNumber: "+91 11 5555 0102",
        friendlyName: "+91 11 5555 0102",
        locality: "Delhi",
        region: "DL",
        isoCountry: "IN",
        capabilities: { voice: true, sms: true, mms: false },
      ...
      {
        phoneNumber: "+91 80 5555 0103",
        friendlyName: "+91 80 5555 0103",
        locality: "Bangalore",
        region: "KA",
        isoCountry: "IN",
        capabilities: { voice: true, sms: true, mms: false },
      ...
      {
        phoneNumber: "+91 44 5555 0104",
        friendlyName: "+91 44 5555 0104",
        locality: "Chennai",
        region: "TN",
        isoCountry: "IN",
        capabilities: { voice: true, sms: true, mms: false },
    ...
    GB: [
      {
        phoneNumber: "+44 20 7555 0101",
        friendlyName: "+44 20 7555 0101",
        locality: "London",
        region: "England",
        isoCountry: "GB",
        capabilities: { voice: true, sms: true, mms: false },
      ...
      {
        phoneNumber: "+44 161 555 0102",
        friendlyName: "+44 161 555 0102",
        locality: "Manchester",
        region: "England",
        isoCountry: "GB",
        capabilities: { voice: true, sms: true, mms: false },
    ...
    AU: [
      {
        phoneNumber: "+61 2 5555 0101",
        friendlyName: "+61 2 5555 0101",
        locality: "Sydney",
        region: "NSW",
        isoCountry: "AU",
        capabilities: { voice: true, sms: true, mms: false },
      ...
      {
        phoneNumber: "+61 3 5555 0102",
        friendlyName: "+61 3 5555 0102",
        locality: "Melbourne",
        region: "VIC",
        isoCountry: "AU",
        capabilities: { voice: true, sms: true, mms: false },
...
function getRegulatoryRequirements(country: string, numberType: string): RegulatoryRequirement {
  return (
    REGULATORY_REQUIREMENTS[country]?.[numberType] || {
      required: false,
      documents: [],
      addressRequired: false,
      addressType: "none",
