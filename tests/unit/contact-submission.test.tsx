...
describe('ContactPage Submission', () => {
    ...
    it('should render fields and submit successfully', async () => {
        ...
        fireEvent.change(screen.getByPlaceholderText(/Enter email address/i), { target: { value: 'jane@example.com' } });
        fireEvent.change(screen.getByPlaceholderText(/Enter your message/i), { target: { value: 'Hello there!' } });
