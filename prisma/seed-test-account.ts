...
async function main() {
    ...
    if (existing) {
        ...
        await prisma.serviceInventoryLink.deleteMany({ where: { service: { workspaceId: existing.id } } });
    ...
    const staffData = [
        { email: "jordan.smith@careops.test", name: "Jordan Smith", canInbox: true, canBookings: true, canForms: true, canInventory: false },
        { email: "casey.lee@careops.test", name: "Casey Lee", canInbox: true, canBookings: false, canForms: true, canInventory: true },
        { email: "morgan.chen@careops.test", name: "Morgan Chen", canInbox: false, canBookings: true, canForms: false, canInventory: true },
        { email: "riley.patel@careops.test", name: "Riley Patel", canInbox: true, canBookings: true, canForms: true, canInventory: true },
        { email: "drew.kim@careops.test", name: "Drew Kim", canInbox: false, canBookings: false, canForms: true, canInventory: false },
    ];
    ...
    console.log("\n🩺 Creating Services...");
    const servicesData = [
        { name: "General Consultation", duration: 60, price: 150, desc: "Standard health consultation" },
        { name: "Physical Therapy", duration: 45, price: 120, desc: "Physiotherapy and rehabilitation" },
        { name: "Mental Health Assessment", duration: 90, price: 200, desc: "Psychological evaluation" },
    ...
    const contactsData = [
        { name: "Olivia Hartman", email: "olivia.h@gmail.com", phone: "+1-415-555-0201", source: "form" },
        { name: "Ethan Nguyen", email: "ethan.n@email.com", phone: "+1-415-555-0202", source: "referral" },
        { name: "Sophia Patel", email: "sophia.p@outlook.com", phone: "+1-415-555-0203", source: "form" },
        { name: "Liam Okafor", email: "liam.o@gmail.com", phone: "+1-415-555-0204", source: "search" },
        { name: "Ava Thompson", email: "ava.t@email.com", phone: "+1-415-555-0205", source: "referral" },
        { name: "Noah Castillo", email: "noah.c@gmail.com", phone: "+1-415-555-0206", source: "form" },
        { name: "Isabella Kim", email: "isabella.k@outlook.com", phone: "+1-415-555-0207", source: "search" },
        { name: "Mason Fernandez", email: "mason.f@email.com", phone: "+1-415-555-0208", source: "form" },
        { name: "Mia Johnson", email: "mia.j@gmail.com", phone: "+1-415-555-0209", source: "referral" },
        { name: "James Williams", email: "james.w@email.com", phone: "+1-415-555-0210", source: "form" },
        { name: "Charlotte Brown", email: "charlotte.b@gmail.com", phone: "+1-415-555-0211", source: "search" },
        { name: "Benjamin Davis", email: "ben.d@outlook.com", phone: "+1-415-555-0212", source: "form" },
        { name: "Amelia Martinez", email: "amelia.m@email.com", phone: "+1-415-555-0213", source: "referral" },
        { name: "Elijah Anderson", email: "elijah.a@gmail.com", phone: "+1-415-555-0214", source: "form" },
        { name: "Harper Wilson", email: "harper.w@email.com", phone: "+1-415-555-0215", source: "search" },
        { name: "Lucas Moore", email: "lucas.m@gmail.com", phone: "+1-415-555-0216", source: "referral" },
        { name: "Evelyn Taylor", email: "evelyn.t@outlook.com", phone: "+1-415-555-0217", source: "form" },
        { name: "Henry Jackson", email: "henry.j@email.com", phone: "+1-415-555-0218", source: "form" },
        { name: "Abigail White", email: "abigail.w@gmail.com", phone: "+1-415-555-0219", source: "search" },
        { name: "Sebastian Harris", email: "sebastian.h@email.com", phone: "+1-415-555-0220", source: "referral" },
    ];
    ...
    const setHM = (d: Date, h: number, m: number) => { const r = new Date(d); r.setHours(h, m, 0, 0); return r; };
    ...
    for (const b of bookingsData) {
        ...
        console.log(`   ✓ ${contacts[b.ci].name} → ${svc.name} @ ${b.date.toLocaleTimeString()} (${b.status})`);
    }
    ...
    const contactForm = await prisma.contactForm.create({
        data: {
            ...
            welcomeMessage: "Welcome to CareOps Test Clinic! Fill out this form and we'll be in touch within 24 hours.",
            isActive: true,
            fields: JSON.stringify([
    ...
    await prisma.formSubmission.create({
        data: { workspaceId: workspace.id, contactId: contacts[0].id, intakeFormId: intakeForm1.id, bookingId: bookings[0].id, status: "PENDING", sentAt: subDays(today, 1) },
    });
    await prisma.formSubmission.create({
        data: { workspaceId: workspace.id, contactId: contacts[1].id, intakeFormId: intakeForm1.id, bookingId: bookings[1].id, status: "SENT", sentAt: subDays(today, 1) },
    });
    await prisma.formSubmission.create({
        data: { workspaceId: workspace.id, contactId: contacts[7].id, intakeFormId: intakeForm2.id, bookingId: bookings[7].id, status: "COMPLETED", sentAt: subDays(today, 2), completedAt: subDays(today, 1) },
    });
    await prisma.formSubmission.create({
        data: { workspaceId: workspace.id, contactId: contacts[9].id, intakeFormId: intakeForm1.id, bookingId: bookings[9].id, status: "OVERDUE", sentAt: subDays(today, 4), dueDate: subDays(today, 2) },
    });
    ...
    const inventoryData = [
        { name: "Disposable Gloves (Box)", qty: 3, threshold: 5, unit: "boxes", vendor: "MedSupply Co.", vendorEmail: "orders@medsupply.test" },
        { name: "Surgical Masks", qty: 8, threshold: 10, unit: "packs", vendor: "SafeGear Inc.", vendorEmail: "supply@safegear.test" },
        { name: "Blood Pressure Cuffs", qty: 6, threshold: 3, unit: "units", vendor: "ClinEquip Ltd.", vendorEmail: null },
        { name: "Antibacterial Wipes", qty: 2, threshold: 5, unit: "cartons", vendor: "CleanMed", vendorEmail: "orders@cleanmed.test" },
        { name: "Exam Table Paper", qty: 12, threshold: 4, unit: "rolls", vendor: "MedSupply Co.", vendorEmail: "orders@medsupply.test" },
        { name: "Sterile Gauze Pads", qty: 4, threshold: 8, unit: "packs", vendor: "WoundCare Pro", vendorEmail: null },
        { name: "Otoscope Earpieces", qty: 50, threshold: 20, unit: "pieces", vendor: "ClinEquip Ltd.", vendorEmail: null },
        { name: "Hand Sanitizer (1L)", qty: 3, threshold: 6, unit: "bottles", vendor: "CleanMed", vendorEmail: "orders@cleanmed.test" },
    ];
    ...
    for (const inv of inventoryData) {
        ...
        console.log(`   ${lowStock ? "⚠️ " : "✓ "} ${inv.name} (${inv.qty}/${inv.threshold} ${inv.unit})${lowStock ? " — LOW STOCK" : ""}`);
    ...
    await prisma.serviceInventoryLink.create({ data: { serviceId: services[0].id, inventoryId: inventoryItems[0].id, quantity: 1 } });
    await prisma.serviceInventoryLink.create({ data: { serviceId: services[0].id, inventoryId: inventoryItems[1].id, quantity: 1 } });
    await prisma.serviceInventoryLink.create({ data: { serviceId: services[1].id, inventoryId: inventoryItems[4].id, quantity: 2 } });
    ...
    const automationRules = [
        {
            ...
            trigger: "NEW_CONTACT",
            messageTemplate: "Welcome to CareOps Test Clinic, {{contact_name}}! We're happy to have you. Our team will reach out shortly to discuss your needs.",
            delayMinutes: 0,
            isActive: true,
        },
        {
            ...
            messageTemplate: "Hi {{contact_name}}, your {{service_name}} is confirmed for {{date}}. Please arrive 10 minutes early. Reply CANCEL to reschedule.",
            delayMinutes: 0,
            isActive: true,
        },
        {
            ...
            messageTemplate: "Reminder: Hi {{contact_name}}, you have a {{service_name}} appointment tomorrow. We look forward to seeing you!",
            delayMinutes: 1440,
            isActive: true,
        },
        {
            ...
            messageTemplate: "Hi {{contact_name}}, your intake form is still pending. Please complete it before your appointment: {{form_url}}",
            delayMinutes: 60,
            isActive: true,
        },
        {
            ...
            messageTemplate: "⚠️ {{item_name}} is running low ({{qty}} remaining, threshold: {{threshold}}). Please reorder from {{vendor_name}}.",
            delayMinutes: 0,
            isActive: true,
        },
        {
    ...
    await prisma.automationLog.create({
        data: { ruleId: createdRules[0].id, trigger: "NEW_CONTACT", status: "SUCCESS", recipient: contacts[0].email!, details: "Welcome email sent" },
    });
    await prisma.automationLog.create({
        data: { ruleId: createdRules[1].id, trigger: "BOOKING_CREATED", status: "SUCCESS", recipient: contacts[1].email!, details: "Confirmation email sent" },
    });
    await prisma.automationLog.create({
        data: { ruleId: createdRules[1].id, trigger: "BOOKING_CREATED", status: "FAILED", recipient: "bad@email", details: "SMTP delivery failed: invalid address" },
    });
    ...
    console.log("\n🔔 Creating Alerts...");
    const alertsData = [
        { type: "booking", title: "New Booking", message: `${contacts[0].name} booked General Consultation for today 9:00 AM`, actionUrl: "/bookings", isRead: false },
        { type: "booking", title: "New Booking", message: `${contacts[4].name} booked Physical Therapy for tomorrow 9:30 AM`, actionUrl: "/bookings", isRead: false },
        { type: "inventory", title: "Low Stock Alert", message: "Disposable Gloves (Box) is running low (3 boxes, threshold: 5)", actionUrl: "/inventory", isRead: false },
        { type: "inventory", title: "Low Stock Alert", message: "Antibacterial Wipes running low (2 cartons, threshold: 5)", actionUrl: "/inventory", isRead: false },
        { type: "inventory", title: "Low Stock Alert", message: "Sterile Gauze Pads running low (4 packs, threshold: 8)", actionUrl: "/inventory", isRead: false },
        { type: "inventory", title: "Low Stock Alert", message: "Hand Sanitizer (1L) running low (3 bottles, threshold: 6)", actionUrl: "/inventory", isRead: false },
        { type: "automation", title: "Automation Paused", message: `Staff replied to ${contacts[15].name} — automation paused for 24h`, actionUrl: "/inbox", isRead: true },
        { type: "form", title: "Overdue Form", message: `${contacts[9].name} has an overdue intake form`, actionUrl: "/forms", isRead: false },
    ];
